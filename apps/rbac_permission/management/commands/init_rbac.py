    ...
    def handle(self, *args, **options):
        ...
        menus_tree = [
            ...
            {"title": "SRE运维", "title_en": "SRE", "key": "sre", "path": "sre", "icon": "carbon:uv-index-alt", "order": 8, "children": [
                ...
                {"title": "诊断中心", "title_en": "Diagnosis Center", "key": "sre-diagnosis", "path": "v1/sre/diagnosis", "icon": "carbon:debug", "order": 1},
                {"title": "任务脉搏", "title_en": "Task Pulse", "key": "sre-pulse", "path": "v1/sre/pulse", "icon": "carbon:activity", "order": 2},
                {"title": "告警报表", "title_en": "Alert Report", "key": "sre-report", "path": "v1/sre/report", "icon": "carbon:report", "order": 3},
            ]},
