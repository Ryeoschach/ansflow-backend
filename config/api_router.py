...
from apps.rbac_permission.views import UserViewSet, RoleViewSet, PermissionViewSet, MenuViewSet, AuditLogViewSet, ProjectViewSet, ProjectAssetShareViewSet, ProjectMemberViewSet
...
from apps.system_management.views import SystemHealthViewSet, DashboardViewSet, BackupViewSet, PeriodicTaskViewSet, UserNotificationViewSet, SystemReportViewSet
...
router.register(r'system/reports', SystemReportViewSet, basename='system-reports')
