...
class PipelineSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Pipeline
        fields = ['id', 'name', 'desc', 'graph_data', 'creator', 'creator_name', 'project', 'is_active', 'timeout', 'cron_expression', 'is_cron_enabled', 'celery_periodic_task_id', 'create_type', 'create_time', 'update_time', 'current_version']
