...
from apps.ai_engine import consumers as ai_consumers
from apps.system_management import consumers as system_consumers
...
websocket_urlpatterns = [
    ...
    re_path(r'ws/ai/chat/$', ai_consumers.AIChatConsumer.as_asgi()),
    re_path(r'ws/notifications/$', system_consumers.NotificationConsumer.as_asgi()),
]
