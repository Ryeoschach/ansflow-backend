...
from apps.task_management.models import AnsibleExecution, AnsibleTask, AnsibleSchedule
...
class AnsibleScheduleFilter(django_filters.FilterSet):
    task_name = django_filters.CharFilter(field_name='task__name', lookup_expr='icontains')

    class Meta:
        model = AnsibleSchedule
        fields = ['is_enabled', 'schedule_type', 'task']
